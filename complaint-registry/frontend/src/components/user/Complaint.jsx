...
const Complaint = () => {
   ...
   return (
      <>
         <div className="text-white complaint-box" style={{}}>
            <form onSubmit={handleSubmit} className="compliant-form row bg-dark ">
              ...
              <br /><br />
               <div className="text-center p-1 col-12" style={{marginTop:"20px",marginBottom:"40px"}}>
                  <button type="submit" onClick={handleSubmit} className="mt-2 btn btn-success" style={{backgroundColor:"rgb(20, 220, 47)"}}>REGISTER</button>
               </div>
            </form>
         </div>
      </>
